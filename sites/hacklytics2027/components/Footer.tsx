...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full border-t border-white/5 bg-[#020204]/90 backdrop-blur-3xl overflow-hidden">
      ...
      <div className="section-wrap max-w-7xl mx-auto py-16 md:py-24 px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-20 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4 group cursor-pointer w-fit">
              <div className="relative w-10 h-10 rounded-full overflow-hidden border border-white/10 group-hover:border-bloom-cyan/40 transition-colors duration-500">
                <Image src="/logo.png" alt="Hacklytics" fill className="object-contain" />
              </div>
              <span className="font-sans font-medium text-sm tracking-[0.2em] text-white/70 group-hover:text-white transition-colors duration-500">
                HACKLYTICS 2027
              </span>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <span className="font-mono text-[10px] text-white/20 uppercase tracking-[0.4em] mb-2">Navigation</span>
          ...
          {/* Contact */}
          <div className="flex flex-col gap-4">
            <span className="font-mono text-[10px] text-white/20 uppercase tracking-[0.4em] mb-2">Connect</span>
            ...
            <Link href="https://static.mlh.io/docs/mlh-code-of-conduct.pdf" target="_blank" rel="noopener noreferrer"
              className="mt-4 font-mono text-[10px] text-white/40 hover:text-white transition-colors duration-500 border border-white/10 hover:border-white/30 px-5 py-3 rounded-full w-fit tracking-[0.2em] uppercase">
              MLH Code of Conduct
            </Link>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <p className="font-mono text-[10px] text-white/30 tracking-widest uppercase">© 2027 Data Science @ GT</p>
          <p className="font-mono text-[10px] text-white/30 flex items-center gap-2 tracking-widest uppercase">
