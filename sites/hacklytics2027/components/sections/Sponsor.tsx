...
export default function SponsorsSection() {
  return (
    <section
      id="sponsors"
      className="section-anchor scroll-mt-20 border-b border-gridline bg-transparent text-white flex flex-col relative overflow-hidden min-h-screen"
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center items-center px-6 md:px-12 py-24 md:py-32 text-center mt-20 max-w-7xl mx-auto w-full">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 border border-bloom-cyan/30 bg-black/60 px-6 py-2 mb-8 animate-pulse hover:border-bloom-cyan transition-colors rounded-full"
        >
          <span className="w-2 h-2 rounded-full bg-bloom-cyan shadow-[0_0_10px_var(--bloom-cyan)]"></span>
          <span className="text-xs font-mono tracking-widest uppercase text-bloom-cyan">
            Interest Form Open
          </span>
        </a>
        ...
        <h1 className="font-sans text-5xl md:text-8xl lg:text-[8rem] font-bold tracking-tighter uppercase relative z-10 leading-[0.85] mb-6 drop-shadow-2xl">
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-white via-bloom-pink to-bloom-cyan">
            Our
          </span>{" "}
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-bloom-cyan via-bloom-lime to-white">
            Partners
          </span>
        </h1>
        ...
        <p className="font-mono text-sm md:text-base text-gray-300 uppercase tracking-widest mb-16 max-w-2xl leading-relaxed bg-black/40 p-6 border-l-4 border-bloom-pink">
          ...
          Special thanks to our visionary partners.
        </p>
        ...
        <div className="w-full flex flex-col gap-12 md:gap-16 mb-20 relative z-10">
          ...
          <div className="flex flex-col items-center">
            <h2 className="font-mono text-xs uppercase tracking-[0.3em] font-bold text-bloom-lime mb-6 drop-shadow-[0_0_5px_currentColor]">
              Gold Partners
            </h2>
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 w-full max-w-4xl">
              {goldSponsors.map((s) => (
                <div
                  key={s.name}
                  className="glass-panel px-10 py-8 flex items-center justify-center min-w-[260px] h-[120px] hover:border-bloom-lime/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(204,255,0,0.15)] bg-black/30 group"
                >
          ...
          {/* Silver Tier */}
          <div className="flex flex-col items-center">
            <h2 className="font-mono text-xs uppercase tracking-[0.3em] font-bold text-bloom-cyan mb-6 drop-shadow-[0_0_5px_currentColor]">
              Silver Partners
            </h2>
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 w-full max-w-4xl">
              {silverSponsors.map((s) => (
                <div
                  key={s.name}
                  className="glass-panel px-8 py-6 flex items-center justify-center min-w-[220px] h-[100px] hover:border-bloom-cyan/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(0,243,255,0.15)] bg-black/30 group"
                >
          ...
          {/* Bronze Tier */}
          <div className="flex flex-col items-center">
            <h2 className="font-mono text-xs uppercase tracking-[0.3em] font-bold text-bloom-pink mb-6 drop-shadow-[0_0_5px_currentColor]">
              Bronze Partners
            </h2>
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 w-full max-w-5xl">
              {bronzeSponsors.map((s) => (
                <div
                  key={s.name}
                  className="glass-panel px-6 py-4 flex items-center justify-center min-w-[180px] h-[80px] hover:border-bloom-pink/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(255,0,127,0.15)] bg-black/30 group"
                >
          ...
          {/* Mini Tier */}
          <div className="flex flex-col items-center">
            <h2 className="font-mono text-xs uppercase tracking-[0.3em] font-bold text-bloom-purple mb-6 drop-shadow-[0_0_5px_currentColor]">
              Additional Partners
            </h2>
            <div className="flex flex-wrap justify-center gap-4 w-full max-w-5xl">
              {miniSponsors.map((s) => (
                <div
                  key={s.name}
                  className="glass-panel px-4 py-3 flex items-center justify-center min-w-[140px] h-[65px] hover:border-bloom-purple/50 transition-all duration-300 hover:-translate-y-1 bg-black/30 group"
                >
        ...
        <div className="flex flex-col sm:flex-row gap-6 items-center z-10">
          ...
          >
            <span className="relative z-10 text-white group-hover:text-bloom-cyan font-bold transition-colors">
              Become a Partner
            </span>
      ...
      <footer className="w-full px-6 md:px-12 py-12 glass-panel border-t border-gridline relative z-10 flex flex-col gap-12 !rounded-none !bg-black/60">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          {/* Brand */}
          <div>
            <h2 className="font-sans text-3xl font-bold uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-bloom-pink to-bloom-cyan mb-2">
              Hacklytics 2027
            </h2>
          ...
          <div className="flex flex-wrap gap-6 font-mono text-xs uppercase tracking-widest text-gray-400">
            <Link
              href="mailto:hello@hacklytics.io"
              className="hover:text-bloom-cyan transition-colors"
            >
              Contact
            </Link>
            <Link
              href="https://instagram.com/dsgt"
              className="hover:text-bloom-pink transition-colors"
            >
              Instagram
            </Link>
            <Link
              href="https://linkedin.com/company/dsgt"
              className="hover:text-bloom-lime transition-colors"
            >
              LinkedIn
            </Link>
            <Link
        ...
        <div className="pt-8 border-t border-gridline flex flex-col md:flex-row justify-between items-center gap-4 font-mono text-xs text-gray-500 uppercase tracking-widest">
          ...
          <div className="flex items-center gap-2">
            Built with <span className="text-bloom-pink animate-pulse">❤</span>{" "}
            by DSGT Tech
          </div>
        </div>
      </footer>
