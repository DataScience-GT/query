    ...
    <section id="sponsors" className="section-anchor relative text-white border-t border-white/[0.06]">
      <div className="section-wrap max-w-7xl mx-auto px-6 py-24 md:py-32">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex items-center justify-center border border-white/20 px-8 py-8 min-h-[5.5rem] sm:min-w-[10rem]">
          ...
          <div className="flex flex-1 items-center justify-center sm:justify-start border border-white/15 px-8 py-8 min-h-[5.5rem]">
