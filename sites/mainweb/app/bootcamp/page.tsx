...
const curriculum = [
    ...
    { week: 2, title: "Control Flow & Structures", desc: "Loops, conditionals, lists, and dictionaries." },
    { week: 3, title: "Functions & Modules", desc: "Writing reusable code and organizing projects." },
    { week: 4, title: "Object-Oriented Programming", desc: "Classes, inheritance, and Pythonic design." },
    { week: 5, title: "File Handling & APIs", desc: "Reading files, writing data, and making web requests." },
    { week: 6, title: "Pandas & NumPy", desc: "Introduction to fast numerical computing and DataFrames." },
    { week: 7, title: "Data Cleaning", desc: "Handling missing values, merging, and data transformations." },
    { week: 8, title: "Exploratory Data Analysis", desc: "Extracting insights and statistical summaries from data." },
    { week: 9, title: "Data Visualization", desc: "Creating stunning charts using Matplotlib and Seaborn." },
    { week: 10, title: "Intro to Machine Learning", desc: "Core concepts, train/test splits, and Scikit-Learn." },
    { week: 11, title: "Supervised Learning", desc: "Linear regression, logistic regression, and decision trees." },
    { week: 12, title: "Capstone Project", desc: "Build an end-to-end data science portfolio piece." }
];
...
export default function BootcampPage() {
    ...
    return (
        <div className="relative min-h-screen bg-[#050505] text-gray-400 font-sans selection:bg-[#00A8A8]/30">
            ...
            <main className="relative z-10 pt-40 pb-20 px-6 lg:px-12 max-w-7xl mx-auto text-center">
                <div className="space-y-6 mb-16">
                    ...
                    <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto italic">
                        Master Python for data science in 12 weeks. From the fundamentals to machine learning, build the skills you need to succeed.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                    {curriculum.map((item, index) => (
                        <div key={index} className="group relative p-[1px] rounded-xl bg-gradient-to-b from-white/10 to-transparent hover:from-[#00A8A8]/50 transition-colors duration-500 overflow-hidden">
            ...
            <Footer screen_width={windowWidth} className="fixed bottom-0 z-10 mt-20" />
        </div>
    );
}
