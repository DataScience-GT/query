    ...
    return (
        <div className="relative min-h-screen bg-[var(--bg-secondary)] flex flex-col items-center justify-center px-6 text-center overflow-hidden">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-gradient-to-r from-accent/5 via-cyan-900/10 to-purple-900/8 blur-[400px] rounded-sm" />
                <div className="absolute bottom-[-15%] right-[-10%] w-[700px] h-[700px] bg-gradient-to-r from-emerald-900/10 via-cyan-900/10 to-indigo-900/8 blur-[350px] rounded-sm" />
                    ...
                    {code.map((digit, i) => (
                        <input
                            ...
                            className={`
                                ...
                                bg-black/40 border-[1.5px] rounded-none
