...
function statusConfig(s: string) {
    ...
    return map[s] ?? { label: s, dot: 'bg-gray-500', text: 'text-[var(--text-muted)]', bg: 'bg-gray-500/10', border: 'border-gray-500/20', glow: '' };
}
            ...
            <main className="relative z-10 max-w-7xl mx-auto py-24 px-6 md:px-12">
                ...
                <div className="relative z-10">
                    {tab === 'INFO' ? (
                        ...
                        <TeamsTab hackathonId={hackathon.id} isRegistered={isRegistered} myTeamId={myReg?.teamId ?? null} />
                    )}
                </div>
            </main>
        </div>
