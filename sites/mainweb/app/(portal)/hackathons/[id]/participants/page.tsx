...
export default function ParticipantHackathonPage() {
  ...
  // this branch the loading guard above never clears and the page spins
  ...
  return (
    <div className="relative min-h-screen bg-[var(--bg-primary)] text-text-muted font-sans selection:bg-emerald-500/30 overflow-hidden">
      ...
      <main className="relative z-10 max-w-5xl mx-auto py-24 px-6 md:px-12">
        <Link
          href="/hackathons"
          className="inline-flex items-center gap-2 text-[var(--text-primary)]/40 hover:text-[var(--text-primary)] transition-colors text-sm font-medium mb-12 group"
        >
