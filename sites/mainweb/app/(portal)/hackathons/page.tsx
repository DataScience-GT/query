          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {!hackathons || hackathons.length === 0 ? (
              <LiquidGlass className="relative z-10 max-w-lg w-full mx-auto p-12 text-center flex flex-col items-center border border-white/5">
                ...
                <p className="text-sm text-white/40 leading-relaxed">There are currently no hackathons available. Check back soon.</p>
              </LiquidGlass>
            ) : (
                        ...
                        <LiquidGlass className="h-full flex flex-col p-1 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] bg-white/[0.01] border-white/5 hover:bg-white/[0.02] hover:border-white/20">
                          <div className="relative flex flex-col h-full bg-[var(--bg-tertiary)] rounded-2xl p-6 md:p-8 overflow-hidden z-10">
                            ...
                            <div className="flex-1 relative z-10">
                              {h.theme && <p className="text-cyan-400/80 text-xs font-mono mb-3 uppercase tracking-wider">{h.theme}</p>}
                              <h2 className="text-2xl font-bold text-white mb-3 group-hover:text-cyan-300 transition-colors duration-300 leading-tight">{h.name}</h2>
                              {h.description && <p className="text-sm text-white/50 line-clamp-3 leading-relaxed mb-6">{h.description}</p>}
                            </div>
