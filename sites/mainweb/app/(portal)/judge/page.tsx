...
export default function JudgePage() {
  ...
  const confMap: Record<string, { label: string; bg: string; border: string }> = {
    open: { label: 'Accepting Judges', bg: 'bg-emerald-400/10', border: 'border-emerald-400/30' },
    in_progress: { label: 'Active', bg: 'bg-cyan-400/10', border: 'border-cyan-400/30' },
    completed: { label: 'Completed', bg: 'bg-white/5', border: 'border-white/10' },
