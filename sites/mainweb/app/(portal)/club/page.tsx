...
export default function ClubPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-gray-400 font-sans selection:bg-[#00E5FF]/30 overflow-x-hidden relative pb-20">

      {/* Background Ambience */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] bg-[#00E5FF]/5 blur-[200px] rounded-sm animate-[float_20s_ease-in-out_infinite]" />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-12 md:pt-20 lg:pt-24 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="relative overflow-hidden rounded-none border border-white/10 bg-[#000000]/80 backdrop-blur-xl shadow-2xl p-8 md:p-12 mb-8 md:mb-12">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#00E5FF] via-[#6366f1] to-[#00E5FF]" />

          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              <div className="relative group shrink-0">
                <div className="absolute -inset-1 rounded-sm bg-gradient-to-r from-[#00E5FF] to-purple-500 opacity-50 blur-lg transition-all duration-500 group-hover:opacity-100 group-hover:scale-110" />
                {userData?.image ? (
                  <Image
                    src={userData.image}
                    alt="Avatar"
                    width={80}
                    height={80}
                    className="relative w-20 h-20 rounded-sm border-2 border-[#00E5FF] object-cover"
                  />
                ) : (
                  <div className="relative flex w-20 h-20 items-center justify-center rounded-sm border-2 border-[#00E5FF] bg-black text-2xl font-bold text-white">
                    {firstName.charAt(0)}
                  </div>
                )}
              </div>
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-white/5 border border-white/10 mb-3">
                  <div className="w-1.5 h-1.5 rounded-sm bg-[#00E5FF] animate-pulse" />
                  <span className="text-[10px] font-mono text-[#00E5FF] uppercase tracking-widest">Active Member</span>
                </div>
        ...
        <Link
          href="/hackathons"
          className="group relative overflow-hidden flex items-center justify-between gap-4 w-full rounded-none border border-[#00E5FF]/20 bg-[#00E5FF]/5 hover:bg-[#00E5FF]/10 hover:border-[#00E5FF]/40 transition-all duration-300 p-5 md:p-6 mb-8 md:mb-10"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-[#00E5FF]/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
          <div className="flex items-center gap-4 relative z-10">
            <div className="w-10 h-10 rounded-none bg-[#00E5FF]/10 border border-[#00E5FF]/30 flex items-center justify-center shrink-0">
          ...
          <ChevronRight className="w-5 h-5 text-[#00E5FF] shrink-0 group-hover:translate-x-1 transition-transform relative z-10" />
        </Link>
            ...
            {tabs.map((tab) => (
              <Link
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-none font-bold text-sm tracking-wide transition-all duration-300 ${activeTab === tab.id
                  ? 'bg-gradient-to-r from-[#00E5FF]/10 to-transparent border border-[#00E5FF]/30 text-[#00E5FF] shadow-[0_0_20px_rgba(0,168,168,0.15)]'
                  : 'text-gray-400 hover:text-white hover:bg-white/5 border border-transparent'
                  }`}
                onClick={() => setActiveTab(tab.id as Tab)}
              >
                <tab.icon className={`w-4 h-4 ${activeTab === tab.id ? 'text-[#00E5FF]' : 'text-gray-500'}`} />
                {tab.label}
              </Link>
            ))}
          </div>
        ...
        <div className="relative min-h-[400px]">
          ...
          {activeTab === "general" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 group relative overflow-hidden rounded-none border border-white/10 bg-[#000000] shadow-2xl transition-all duration-500 hover:border-[#00E5FF]/30 p-8 md:p-12">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center h-full min-h-[300px]">
                  <div className="w-24 h-24 mb-6 rounded-none bg-[#00E5FF]/10 border border-[#00E5FF]/20 flex items-center justify-center relative">
                    <div className="absolute inset-0 bg-[#00E5FF]/20 blur-xl rounded-sm" />
                    <QrCode className="w-10 h-10 text-[#00E5FF] relative z-10" />
                  </div>
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-[#00E5FF] to-[#00E5FF] rounded-none text-white font-bold tracking-widest text-sm uppercase transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(0,168,168,0.4)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3"
                  >
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="rounded-none border border-white/10 bg-[#000000] p-8 shadow-xl">
                  ...
                  <div className="flex items-end gap-4">
                    ...
                    <span className="text-[#00E5FF] font-bold mb-1">Sessions</span>
                  </div>
                </div>
                ...
                <div className="rounded-none border border-white/10 bg-[#000000] p-8 shadow-xl">
                  ...
                  <ul className="space-y-4 text-sm text-gray-400">
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-sm bg-[#00E5FF] mt-1.5 shrink-0" />
                ...
                <div className="relative border-l-2 border-white/10 ml-4 md:ml-6 space-y-8 pb-4">
                  {myEvents.map((checkIn) => (
                    <div key={checkIn.id} className="relative pl-8 md:pl-12 group">
                      <div className="absolute -left-[9px] top-1/2 -translate-y-1/2 w-4 h-4 rounded-sm border-2 border-[#00E5FF] bg-black group-hover:bg-[#00E5FF] group-hover:scale-125 transition-all shadow-[0_0_10px_rgba(0,168,168,0.5)]" />
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between p-6 md:p-8 rounded-none border border-white/10 bg-gradient-to-r from-[#000000] to-black group-hover:border-[#00E5FF]/30 group-hover:shadow-[0_0_30px_rgba(0,168,168,0.1)] transition-all gap-4">
                        <div>
                          <h4 className="text-xl font-bold text-white mb-3 group-hover:text-[#00E5FF] transition-colors">{checkIn.event.title}</h4>
                        ...
                        <div className="px-5 py-2.5 rounded-none bg-[#00E5FF]/10 text-[#00E5FF] text-xs font-bold tracking-widest uppercase border border-[#00E5FF]/20 flex items-center gap-2 w-max shadow-[0_0_15px_rgba(16,185,129,0.15)]">
          ...
          {activeTab === "status" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl space-y-6">
              <div className="relative overflow-hidden p-8 md:p-10 rounded-none border border-[#00E5FF]/30 bg-[#00E5FF]/10 flex flex-col sm:flex-row sm:items-center justify-between gap-8 shadow-[0_0_50px_rgba(16,185,129,0.15)]">
                <div className="absolute -right-20 -top-20 w-64 h-64 bg-[#00E5FF]/20 blur-[80px] rounded-sm pointer-events-none" />
                <div className="relative z-10">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-[#00E5FF]/20 border border-[#00E5FF]/30 mb-4">
                ...
                <div className="relative z-10 flex items-center justify-center w-20 h-20 shrink-0 rounded-sm bg-[#00E5FF]/20 border border-[#00E5FF]/40 text-emerald-400 shadow-[0_0_30px_rgba(16,185,129,0.3)] backdrop-blur-md">
                  <ShieldCheck className="w-10 h-10" />
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-8 rounded-none border border-white/10 bg-[#000000] hover:border-[#00E5FF]/30 transition-colors shadow-xl">
                ...
                <div className="p-8 rounded-none border border-white/10 bg-[#000000] hover:border-[#00E5FF]/30 transition-colors shadow-xl">
                  ...
                  <div className="inline-block px-5 py-2.5 rounded-none bg-[#00E5FF]/10 border border-[#00E5FF]/30 text-[#00E5FF] font-mono tracking-widest text-sm shadow-[0_0_15px_rgba(0,168,168,0.1)]">
                    {/* @ts-ignore */}
