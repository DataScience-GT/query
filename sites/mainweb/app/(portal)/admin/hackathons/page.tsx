                ...
                <div className="space-y-8">
                    {isLoading || hackathons === undefined ? (
                        <div className="space-y-4">
                            {[1, 2, 3].map((n) => (
                                <div key={n} className="animate-pulse bg-white/5 border border-[var(--border-subtle)] rounded-none p-6 h-36" />
                            ))}
                        </div>
                    ) : hackathons.length === 0 ? (
                        <LiquidGlass className="p-16 text-center">
                            ...
                            <h3 className="text-[var(--text-primary)] font-semibold mb-1">No hackathons yet</h3>
