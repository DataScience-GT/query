        ...
        <AdminLayout>
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-[-20%] left-[-10%] w-[700px] h-[700px] bg-gradient-to-r from-accent/6 via-cyan-900/12 to-purple-900/10 blur-[350px] rounded-sm" />
                    <div className="absolute bottom-[-15%] right-[-8%] w-[600px] h-[600px] bg-gradient-to-r from-emerald-900/12 via-cyan-900/10 to-indigo-900/8 blur-[300px] rounded-sm" />
                </div>
                ...
                <div className="space-y-8">
                    {isLoading || hackathons === undefined ? (
                        <div className="space-y-4">
                            {[1, 2, 3].map((n) => (
                                <div key={n} className="animate-pulse bg-white/5 border border-white/5 rounded-none p-6 h-36" />
                            ))}
                        </div>
                    ) : hackathons.length === 0 ? (
