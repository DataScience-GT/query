            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between">
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-accent to-emerald-500 text-white font-semibold text-sm rounded-xl active:scale-[0.98] transition-transform shadow-[0_0_20px_rgba(var(--accent-rgb),0.2)]"
                  >
                    + New Hackathon
                  </button>
                </div>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-text-muted text-sm">{hackathons?.length || 0} total</p>
                        </div>
                    </div>
