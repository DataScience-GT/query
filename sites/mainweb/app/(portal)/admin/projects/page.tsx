    ...
    <AdminLayout>
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[-15%] left-[-10%] w-[700px] h-[700px] bg-gradient-to-r from-accent/6 via-cyan-900/12 to-purple-900/8 blur-[350px] rounded-sm" />
          <div className="absolute bottom-[-20%] right-[-8%] w-[600px] h-[600px] bg-gradient-to-r from-emerald-900/12 via-cyan-900/10 to-indigo-900/8 blur-[300px] rounded-sm" />
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 bg-black/30 border border-white/5 rounded-none p-1">
              <select
