    ...
    <AdminLayout>
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[-18%] left-[-8%] w-[800px] h-[800px] bg-gradient-to-r from-accent/8 via-cyan-900/15 to-purple-900/12 blur-[400px] rounded-sm" />
          <div className="absolute bottom-[-12%] right-[-10%] w-[700px] h-[700px] bg-gradient-to-r from-emerald-900/15 via-cyan-900/12 to-indigo-900/10 blur-[350px] rounded-sm" />
