            ...
            <main className="relative z-10 max-w-5xl mx-auto px-6 py-24 min-h-screen">
                ...
                <div className="w-full flex justify-between items-center mb-12 group">
                    <Link href="/dashboard" className="text-text-muted hover:text-accent transition-all duration-300 font-mono text-xs tracking-widest uppercase flex items-center gap-2 group-hover:pl-2">
                        ...
                        <span className="bg-gradient-to-r from-gray-400 to-white bg-clip-text text-transparent group-hover:from-white group-hover:to-emerald-300 transition-all">Central Gateway</span>
                    </Link>
                </div>
                ...
                <div className="w-full space-y-12">
                    ...
                    {!myRegs || myRegs.length === 0 ? (
                        <LiquidGlass className="p-12 text-center border-orange-500/20 transition-all duration-500 hover:border-orange-400/30 hover:bg-orange-500/5">
                            <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-4 animate-in fade-in slide-in-from-bottom-4">No Active Registrations</h3>
                            ...
                            <Link href="/hackathons" className="px-8 py-4 bg-white/5 border border-[var(--border-subtle)] text-[var(--text-primary)] font-bold rounded-none hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all duration-300">
                                Browse Hackathons
                            </Link>
                        </LiquidGlass>
                    ) : (
                                ...
                                <LiquidGlass className="p-6">
                                    ...
                                    {currentReg?.team ? (
                                        <div className="space-y-4">
                                            <h3 className="text-sm font-bold text-accent uppercase tracking-widest border-b border-[var(--border-subtle)] pb-2">Active Squad</h3>
                                            <div className="p-4 bg-accent/5 border border-accent/20 rounded-none">
                                                <p className="text-[var(--text-primary)] font-black text-xl tracking-tight mb-4">{currentReg.team.name}</p>

                                                <div className="space-y-2">
                                                    <p className="text-[10px] text-text-muted font-mono uppercase tracking-widest">Team ID (For invites)</p>
                                                ...
                                                <div className="mt-6 pt-4 border-t border-[var(--border-subtle)]">
                                                    <p className="text-[10px] text-text-muted font-mono uppercase tracking-widest mb-2">Members ({currentReg.team.currentMembers}/{currentReg.team.maxMembers})</p>
                                        ...
                                        <div className="space-y-6">
                                            <h3 className="text-sm font-bold text-gray-300 uppercase tracking-widest border-b border-[var(--border-subtle)] pb-2">Squad Formation</h3>
                                            <p className="text-xs font-mono text-text-muted">You are currently operating SOLO. Create or join a team to link your profiles for the final submission.</p>
                            ...
                            <div className="lg:col-span-8 flex flex-col">
                                <LiquidGlass className="p-8 md:p-12 relative overflow-hidden flex-1 border-t-2 border-accent/30 transition-all duration-500 hover:border-accent/50 hover:shadow-[inset_0_0_50px_rgba(16,185,129,0.05)]">
                                    ...
                                    <p className="text-sm font-mono text-text-muted mb-10 relative z-10">
                                        Finalize your hackathon submission. Only the core properties are required. If you are in a team, only the <span className="text-accent font-bold">Captain</span> can deploy the final record.
                                    </p>
                                    ...
                                    {successMessage && (
                                        <div className="p-6 mb-8 bg-accent/10 border border-accent/20 rounded-none relative z-10 flex items-center justify-between">
                                            ...
                                            <Link href="/dashboard" className="px-4 py-2 bg-accent/20 text-accent text-xs rounded hover:bg-accent/30 transition-colors uppercase tracking-widest font-mono">
                                                Return
                                            </Link>
                                        </div>
                                    )}
                                    ...
                                    <form onSubmit={(e) => {
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <label className="block text-xs uppercase tracking-[0.15em] font-bold text-text-muted mb-2 font-mono">Code Name <span className="text-accent">*</span></label>
                                                <input
                                                    type="text"
                                                    required
                                                    value={projectName}
                                            ...
                                            <div>
                                                <label className="block text-xs uppercase tracking-[0.15em] font-bold text-text-muted mb-2 font-mono">Mission Briefing <span className="text-accent">*</span></label>
                                                <textarea
                                                    required
                                                    value={projectDesc}
                                        ...
                                        <div className="p-6 border border-[var(--border-subtle)] rounded-none bg-white/[0.02]">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label className="block text-xs uppercase tracking-[0.15em] font-bold text-text-muted mb-2 font-mono">Repository (GitHub)</label>
                                                    <input
                                                        type="url"
                                                        value={githubUrl}
                                                ...
                                                <div>
                                                    <label className="block text-xs uppercase tracking-[0.15em] font-bold text-text-muted mb-2 font-mono">Video Demo (YouTube)</label>
                                                    <input
                                                        type="url"
                                                        value={videoUrl}
                                                ...
                                                <div>
                                                    <label className="block text-xs uppercase tracking-[0.15em] font-bold text-text-muted mb-2 font-mono">Live Demo (Vercel, etc)</label>
                                                    <input
                                                        type="url"
                                                        value={demoUrl}
                                        ...
                                        <div className="pt-6 border-t border-[var(--border-subtle)] flex items-center justify-between">
                                            ...
                                            <button
                                                ...
                                                className={`px-10 py-5 font-black text-lg uppercase tracking-[0.2em] transition-all flex items-center gap-3 rounded-none shadow-[0_0_30px_rgba(16,185,129,0.2)] hover:shadow-[0_0_50px_rgba(16,185,129,0.4)] hover:scale-[1.02] active:scale-[0.98] ${hasSubmitted
