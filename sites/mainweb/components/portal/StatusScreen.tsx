...
const actionVariantClasses = {
    primary: 'px-12 py-5 bg-white text-black font-black text-[11px] uppercase tracking-[0.2em] rounded-sm hover:bg-[#00E5FF] hover:text-white transition-all active:scale-95 shadow-[0_0_30px_rgba(0,168,168,0.1)]',
...
export function StatusScreen({
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-[#000000] selection:bg-[#00E5FF]/30">
            ...
            {variant === 'success' ? (
                <h1 className="text-4xl font-black text-white uppercase tracking-tighter mb-2">
                    {title.split(' ')[0]}<br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#005a5a] italic">
