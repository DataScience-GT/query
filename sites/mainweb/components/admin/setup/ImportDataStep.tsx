...
export function ImportJudgesStep({
  ...
  return (
    <LiquidGlass className="rounded-none p-8">
      ...
      <p className="text-xs text-[var(--text-subtle)] font-mono mb-6">
        CSV format: name, email, track (optional)
      </p>
...
export function ImportProjectsStep({
  ...
  return (
    <LiquidGlass className="rounded-none p-8">
      ...
      <p className="text-xs text-[var(--text-subtle)] font-mono mb-6">
        CSV format: name, team_members (pipe-separated), main_track,
        extra_tracks (pipe-separated), is_create_x
      </p>
        ...
        <>
          <div className="overflow-x-auto mb-6">
            ...
            {projectsData.length > 20 && (
              <p className="text-xs text-gray-600 font-mono mt-2 text-center">
                ...and {projectsData.length - 20} more
              </p>
            )}
          </div>
