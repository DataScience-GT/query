...
type EventType = 'workshop' | 'meal' | 'ceremony' | 'activity' | 'sponsor_session';

const EVENT_TYPES: { value: EventType; label: string; color: string; bg: string; dot: string }[] = [
    { value: 'workshop', label: 'Workshop', color: 'text-purple-400', bg: 'bg-purple-500/10', dot: 'bg-purple-400' },
    { value: 'meal', label: 'Meal', color: 'text-orange-400', bg: 'bg-orange-500/10', dot: 'bg-orange-400' },
    { value: 'ceremony', label: 'Ceremony', color: 'text-yellow-400', bg: 'bg-yellow-500/10', dot: 'bg-yellow-400' },
    { value: 'activity', label: 'Activity', color: 'text-green-400', bg: 'bg-green-500/10', dot: 'bg-green-400' },
    { value: 'sponsor_session', label: 'Sponsor', color: 'text-blue-400', bg: 'bg-blue-500/10', dot: 'bg-blue-400' },
];
        ...
        <div className="animate-in fade-in zoom-in-95 duration-300">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            ...
                            <button
                                ...
                                className="px-6 py-3 border border-white/10 text-gray-400 font-medium text-sm rounded-none hover:bg-white/5 hover:text-white transition-colors"
                            >
                                Cancel
                            </button>
                        </div>
            ...
            {isLoading ? (
                <div className="py-12 text-center">
                    <p className="text-gray-600 font-mono text-sm uppercase tracking-wider animate-pulse">Loading events...</p>
                </div>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-2 shrink-0">
                                        <button
                                            ...
                                            className="px-4 py-2.5 border border-white/10 text-gray-400 text-sm font-medium rounded-none hover:bg-white/5 hover:text-white transition-colors"
                                        >
                                            Edit
                                        </button>
                                        {deleteConfirm === event.id ? (
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-2.5 border border-white/10 text-gray-500 text-sm rounded-none hover:bg-white/5 transition-colors"
                                                >
                                                    No
                                                </button>
                                            </div>
