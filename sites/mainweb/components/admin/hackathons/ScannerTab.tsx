...
export function ScannerTab({ hackathonId }: { hackathonId: string }) {
    ...
    return (
        <div className="flex flex-col items-center animate-in fade-in zoom-in-95 duration-300 h-full">
            ...
            <LiquidGlass className="p-8 w-full max-w-md mt-4 md:mt-12 rounded-none border-t-4 border-t-[#EAFF2B]/50 shadow-[0_20px_50px_rgba(0,168,168,0.1)]">
                ...
                <div className="space-y-4 mb-8">
                    <label className="text-[10px] font-mono text-[#EAFF2B] uppercase tracking-widest font-bold">Target Event</label>
                    {isLoading ? (
                        <div className="w-full bg-black/50 border border-white/10 rounded-none px-4 py-3 text-gray-500 text-sm font-mono animate-pulse">Loading Events...</div>
                    ) : (
                        <select
                            className="w-full bg-[#EAFF2B]/5 border border-[#EAFF2B]/30 rounded-none px-4 py-4 text-white focus:outline-none focus:border-[#EAFF2B] transition-colors font-medium text-lg shadow-[inset_0_0_20px_rgba(0,168,168,0.05)]"
                ...
                <button
                    ...
                    className="w-full h-32 md:h-40 bg-[#EAFF2B] text-black font-black text-xl uppercase tracking-[0.2em] rounded-none hover:bg-white transition-all active:scale-95 disabled:opacity-30 disabled:scale-100 shadow-[0_0_50px_rgba(0,168,168,0.3)] flex flex-col items-center justify-center gap-2 group"
                >
