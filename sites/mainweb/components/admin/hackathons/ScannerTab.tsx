        ...
        <div className="flex flex-col items-center animate-in fade-in zoom-in-95 duration-300 h-full">
            ...
            <LiquidGlass className="p-8 w-full max-w-md mt-4 md:mt-12 rounded-none border-t-4 border-t-accent/50 shadow-[0_20px_50px_rgba(16,185,129,0.1)]">
                <div className="mb-8 text-center">
                    <h2 className="text-2xl font-black text-[var(--text-primary)] uppercase tracking-tight">Access Control</h2>
                    <p className="text-xs text-[var(--text-subtle)] font-mono mt-2">Select an event and scan badges.</p>
                </div>

                <div className="space-y-4 mb-8">
                    <label className="text-[10px] font-mono text-accent uppercase tracking-widest font-bold">Target Event</label>
                    {isLoading ? (
                        <div className="w-full bg-[var(--bg-primary)]/50 border border-[var(--border-subtle)] rounded-none px-4 py-3 text-[var(--text-subtle)] text-sm font-mono animate-pulse">Loading Events...</div>
                    ) : (
                        <select
