    ...
    <div className="space-y-6 animate-in fade-in duration-300">
        ...
        <LiquidGlass className="p-8 relative overflow-hidden bg-white/[0.01] border-[var(--border-subtle)]">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <h3 className="text-[11px] uppercase tracking-widest font-bold text-accent">
                Your Team
              </h3>
            </div>
            ...
            {myTeam.description && (
              <p className="text-[var(--text-primary)]/50 text-sm mb-6 max-w-2xl leading-relaxed">
                {myTeam.description}
              </p>
            )}
                ...
                (p: {
                  ...
                  >
                    ...
                    {p.userId === myTeam.captainId && (
                      <span className="text-[9px] font-bold text-amber-400 uppercase tracking-widest bg-amber-400/10 px-2 py-0.5 rounded-md ml-1 border border-amber-400/20">
                        Capt
                      </span>
                    )}
                  </div>
        ...
        <LiquidGlass className="p-8 bg-white/[0.01] border-[var(--border-subtle)]">
          {!canCreate ? (
            ...
            >
              ...
              <span className="text-accent font-bold text-sm uppercase tracking-widest group-hover:text-emerald-300 transition-colors">
                Create a New Team
              </span>
            </button>
          ) : (
      ...
      <div>
        <h3 className="text-[11px] uppercase tracking-widest font-bold text-[var(--text-primary)]/40 mb-5 ml-1 flex items-center gap-2">
          ...
          {otherTeams.length > 0
            ? `${otherTeams.length} Team${otherTeams.length !== 1 ? "s" : ""} Looking for Members`
            : "No Teams Yet"}
        </h3>
        ...
        {otherTeams.length === 0 && !myTeam && (
          <LiquidGlass className="p-12 text-center bg-white/[0.01] border-[var(--border-subtle)]">
            ...
            <p className="text-[var(--text-primary)]/40 text-sm font-medium">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5 relative z-10">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-xl font-bold text-[var(--text-primary)] tracking-tight truncate group-hover:text-emerald-300 transition-colors">
                        {team.name}
                      </h3>
                      {!team.isOpen && (
                      ...
                      {isFull && (
                        <span className="text-[9px] font-bold text-amber-400 uppercase tracking-widest bg-amber-500/10 border border-amber-500/20 px-2 py-0.5 rounded-md">
                          Full
                        </span>
                      )}
                    </div>
                    {team.description && (
                      <p className="text-[var(--text-primary)]/50 text-sm mb-4 line-clamp-2 leading-relaxed">
                        {team.description}
                      </p>
                    )}
